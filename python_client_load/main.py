...
import re
import hello_servlet_handler
import logger
import metrics
from random import randint

PORT_NUMBER = 80
LOAD_TEST_SIZE = 5000  # IT SHOULD BE AT LEAST A MULTIPLE OF 10
...
def get_single_request(query):
    try:
        words, servlet_resp_time = hello_servlet_handler.get(query)
        return query, words[:-1], servlet_resp_time
    except Exception as e:
        print("Request failed: " + str(e))
        return query, "failed", "failed"
